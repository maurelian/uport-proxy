...
// Makes sure to run `testrpc -a 25` so you have enough accounts.  
...
// over the proxy with the original owner. Further detail below the test setup.
// for debug mode, use `$ node $(which truffle) test ./test/compromisedKey2.js`
